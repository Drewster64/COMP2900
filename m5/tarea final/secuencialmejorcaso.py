"""
Mejor caso de busqueda secuencial: lista de 1,000 numeros 
"""
import timeit
...
encontrado = busquedaSecuencial("casoMenor.dat", buscar)
tiempo = timeit.timeit(lambda: busquedaSecuencial("casoMenor.dat", buscar), number=1)
